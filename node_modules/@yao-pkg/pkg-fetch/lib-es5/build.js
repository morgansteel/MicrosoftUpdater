        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    tarName = "node-".concat(nodeVersion, ".tar.gz");
                    return [4 /*yield*/, fs_extra_1.default.readFile(path_1.default.join(nodeArchivePath, "".concat(tarName, ".sha256sum")), 'utf8')];
                case 1:
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, fs_extra_1.default.remove(path_1.default.join(nodeArchivePath, "".concat(tarName, ".sha256sum")))];
                case 4:
                    _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    _a.sent();
                    return [4 /*yield*/, fs_extra_1.default.promises.writeFile("".concat(local, ".sha256sum"), "".concat(outputHash, "  ").concat(path_1.default.basename(local), "\n"))];
                case 7:
                    _a.sent();
