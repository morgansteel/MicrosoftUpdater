...
var Log = /** @class */ (function () {
    ...
    Log.prototype.debug = function (text, lines) {
        ...
        console.log("> ".concat(chalk_1.default.green('[debug]'), " ").concat(text));
        this.lines(lines);
    };
